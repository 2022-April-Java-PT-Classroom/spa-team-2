...
public class Populator implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Fish bluefish = new Fish("Bluefish", "Along the East Coast from Maine to eastern Florida", "Bluefish live up to 12 years. They grow fast, up to 31 pounds and 39 inches. They are able to reproduce at age 2, when they’re 15 to 20 inches in length. They exhibit feeding behavior called the “bluefish blitz,” where large schools of big fish attack bait fish near the surface, churning the water like a washing machine. They feed voraciously on their prey, eating almost anything they can catch and swallow.", "Bluefish are blue-green on the back and silvery on the sides and belly. They have a prominent jaw, with sharp, compressed teeth.");
        fishRepo.save(bluefish);
        Fish cobia = new Fish("Cobia", "In U.S. waters, cobia are most abundant from Virginia south through the Gulf of Mexico.", "Cobia are the only member of the family Rachycentridae in North America. They grow up to 6 feet and 100 pounds and live up to 12 years.", "Cobia are dark brown with a single dorsal fin. Young cobia have distinct coloring, with alternating black and white horizontal stripes and splotches of bronze, orange, and green.");
        fishRepo.save(cobia);
