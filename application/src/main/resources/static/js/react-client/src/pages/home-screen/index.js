    ...
    <div className={style.mystere}>
        <div className={style.container}>
            ...
            <div className={style.section1}>
                    <h2><a href='solar-system' alt='solar-system'>Solar System</a> </h2>
                ...
                <div className={style.section2}>
                    <h2><a href='myspace'>The Planets</a></h2>
                ...
                <h2><a href='fish'>Vertebrate Animals: Fish</a></h2>
            ...
            <div className={style.section4}>
                <h2><a href='fish'>Learn about Fish</a></h2>
